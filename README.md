...
1. Install the <a href="https://chrome.google.com/webstore/detail/violentmonkey/jinjaccalgkegednnccohejagnlnfdag">Violentmonkey extension</a> (or similar, e.g, Tampermonkey (never tested it there, but you can give it a try)
